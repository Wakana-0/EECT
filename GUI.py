...
def About(cv):
    ...
    thanks = maliang.UnderlineButton(cv, (400, 100), text="鸣谢", fontsize=16, command=lambda: webbrowser.open_new("https://github.com/EECT/EECT?tab=readme-ov-file#%E9%B8%A3%E8%B0%A2"))
    ...
    open_source_license = maliang.UnderlineButton(cv, (400, 190), text="开放源代码许可", fontsize=16, command=lambda: webbrowser.open_new("https://github.com/EECT/EECT/blob/main/LICENSE"))
